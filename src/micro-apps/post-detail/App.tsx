      ...
      <div className={styles.container}>
        ...
        <div className={styles.main}>
          <div className={styles.mainCard}>
            ...
            {image && (
              <img src={image} alt={post.title} className={styles.postCover} referrerPolicy="no-referrer" />
            )}
            ...
            <div className={styles.otherList}>
              {otherPosts.map((p) => {
                ...
                return (
                  ...
                  >
                    {img && (
                      <img src={img} alt={p.title} className={styles.otherImg} referrerPolicy="no-referrer" />
                    )}
                    <div>
