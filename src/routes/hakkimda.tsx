...
import styles from './hakkimda.module.scss'
...
const techColorKeyMap: Record<string, string> = {
  html:        styles.techHtml,
  css:         styles.techCss,
  sass:        styles.techSass,
  js:          styles.techJs,
  es6:         styles.techEs6,
  babel:       styles.techBabel,
  react:       styles.techReact,
  redux:       styles.techRedux,
  vue:         styles.techVue,
  next:        styles.techNext,
  remix:       styles.techRemix,
  tanstack:    styles.techTanstack,
  storybook:   styles.techStorybook,
  ts:          styles.techTs,
  yarn:        styles.techYarn,
  pnpm:        styles.techPnpm,
  tailwind:    styles.techTailwind,
  bem:         styles.techBem,
  webpack:     styles.techWebpack,
  gulp:        styles.techGulp,
  graphql:     styles.techGraphql,
  pwa:         styles.techPwa,
  reactNative: styles.techReactNative,
  node:        styles.techNode,
}

function TechItem({ name, icon, colorKey }: { name: string; icon: ReactNode; colorKey: string }) {
  return (
    <div className={`${styles.techItem} ${techColorKeyMap[colorKey] ?? ''}`}>
    ...
    <section className={styles.section}>
      <div className={styles.container}>
        <div className={styles.heading}>
          <span className={styles.badge}>Kısaca Ben</span>
          <h2 className={styles.title}>Hakkımda</h2>
          <p className={styles.subtitle}>Frontend geliştirici olarak deneyimlerim</p>
        </div>
        ...
        <div className={styles.inner}>
          ...
          <div className={styles.profileArea}>
            ...
            <h3 className={styles.name}>Yasin Ateş</h3>
            ...
            <div className={styles.socialRow}>
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Medium"
                className={`${styles.socialLink} ${styles.socialMedium}`}
              >
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Dev.to"
                className={`${styles.socialLink} ${styles.socialDevto}`}
              >
                <svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Tech stack */}
          <div>
            <h3 className={styles.techTitle}>Kullandığım Teknolojiler</h3>
            <div className={styles.techGrid}>
              {/* HTML5 */}
              <TechItem name="HTML5" colorKey="html" icon={<i className="ri-html5-fill ri-3x" />} />
              {/* CSS3 */}
              <TechItem name="CSS3" colorKey="css" icon={<i className="ri-css3-fill ri-3x" />} />
              {/* SASS */}
              <TechItem name="SASS" colorKey="sass" icon={
              ...
              {/* JavaScript */}
              <TechItem name="JavaScript" colorKey="js" icon={<i className="ri-javascript-fill ri-3x" />} />
              {/* ES6 */}
              <TechItem name="ES6" colorKey="es6" icon={<i className="ri-javascript-fill ri-3x" />} />
              {/* Babel */}
              <TechItem name="Babel" colorKey="babel" icon={
                <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} viewBox="0 0 32 32" fill="currentColor">
              ...
              {/* React */}
              <TechItem name="React" colorKey="react" icon={<i className="ri-reactjs-fill ri-3x" />} />
              {/* Redux */}
              <TechItem name="Redux" colorKey="redux" icon={
                <svg xmlns="http://www.w3.org/2000/svg" width={35} height={35} preserveAspectRatio="xMidYMid" viewBox="0 -6 256 256" fill="currentColor">
              ...
              {/* Vue.js */}
              <TechItem name="Vue.js" colorKey="vue" icon={
                <svg width="40" height="40" viewBox="0 0 261.76 226.69" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Next.js */}
              <TechItem name="Next.js" colorKey="next" icon={
              ...
              {/* Storybook */}
              <TechItem name="Storybook" colorKey="storybook" icon={
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={40} height={40} preserveAspectRatio="xMidYMid" viewBox="-31.5 0 319 319">
                  <defs>
                    <path id="sb-a" d="M9.872 293.324.012 30.574C-.315 21.895 6.338 14.54 15.005 14L238.494.032c8.822-.552 16.42 6.153 16.972 14.975.02.332.031.665.031.998v286.314c0 8.839-7.165 16.004-16.004 16.004-.24 0-.48-.005-.718-.016l-213.627-9.595c-8.32-.373-14.963-7.065-15.276-15.388Z" />
                  </defs>
                  <mask id="sb-b" fill="#fff"><use xlinkHref="#sb-a" /></mask>
                  <use xlinkHref="#sb-a" fill="#FF4785" />
                  <path fill="#FFF" d="m188.665 39.127 1.527-36.716L220.884 0l1.322 37.863a2.387 2.387 0 0 1-3.864 1.96l-11.835-9.325-14.013 10.63a2.387 2.387 0 0 1-3.829-2.001Zm-39.251 80.853c0 6.227 41.942 3.243 47.572-1.131 0-42.402-22.752-64.684-64.415-64.684-41.662 0-65.005 22.628-65.005 56.57 0 59.117 79.78 60.249 79.78 92.494 0 9.052-4.433 14.426-14.184 14.426-12.705 0-17.729-6.49-17.138-28.552 0-4.786-48.458-6.278-49.936 0-3.762 53.466 29.548 68.887 67.665 68.887 36.935 0 65.892-19.687 65.892-55.326 0-63.36-80.961-61.663-80.961-93.06 0-12.728 9.455-14.425 15.07-14.425 5.909 0 16.546 1.042 15.66 24.801Z" mask="url(#sb-b)" />
                </svg>
              } />
              {/* TypeScript */}
              <TechItem name="TypeScript" colorKey="ts" icon={
              ...
              {/* Yarn */}
              <TechItem name="Yarn" colorKey="yarn" icon={
              ...
              {/* Pnpm */}
              <TechItem name="Pnpm" colorKey="pnpm" icon={
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={40} height={40} viewBox="66.092 33.5 184.5 184.5">
                  <defs>
              ...
              {/* Tailwind */}
              <TechItem name="Tailwind" colorKey="tailwind" icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33" width={40} height={40}>
              ...
              {/* BEM */}
              <TechItem name="BEM" colorKey="bem" icon={<span style={{ fontSize: '1.5rem', fontWeight: 700 }}>BEM</span>} />
              {/* Webpack */}
              <TechItem name="Webpack" colorKey="webpack" icon={
              ...
              {/* Gulp */}
              <TechItem name="Gulp" colorKey="gulp" icon={
                <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="-6.5 0 24 24" fill="currentColor">
              ...
              {/* GraphQL */}
              <TechItem name="GraphQL" colorKey="graphql" icon={
                <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} viewBox="-1.5 0 24 24" fill="currentColor">
              ...
              {/* PWA */}
              <TechItem name="PWA" colorKey="pwa" icon={<span style={{ fontSize: '1.5rem', fontWeight: 700 }}>PWA</span>} />
              {/* React Native */}
              <TechItem name="React Native" colorKey="reactNative" icon={<i className="ri-reactjs-fill ri-3x" />} />
              {/* Node.js */}
              <TechItem name="Node.js" colorKey="node" icon={
